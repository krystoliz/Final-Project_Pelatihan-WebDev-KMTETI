...
func main() {
	...
	h.HandleFunc("/api/books", handler.BookHandler) //if p is lowercase it wont be accessible to this file. If p is uppercase it will be accessible.
	h.HandleFunc("/api/test-db", handler.NewProductHandler)
